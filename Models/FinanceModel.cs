...
public class FinanceModel
{
    ...
    public string? clasification { get; set; } // Income, Outcome
    public string? description { get; set; } // description of the investment
    public string? platform { get; set; } // etoro, coinbase, binance, BBVA, BRIQ, SNOWBALL, LENDERA, cetesdirecto, GBM+, other
    public string? type { get; set; } // stock, bond, fund, crypto, real estate, business, collectible, bank account, business, work, other
    ...
    public string? currencyCode { get; set; } // MXN, USD, EUR, other
